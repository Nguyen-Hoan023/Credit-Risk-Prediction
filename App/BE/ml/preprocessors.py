"""
ml/preprocessors.py — Custom sklearn transformers used in the LightGBM pipeline.
IMPORTANT: This file MUST exist for joblib.load(lgbm_pipeline.pkl) to find the classes.
Moved from preprocessors.py — logic unchanged.
"""
import pandas as pd
